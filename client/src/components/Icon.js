        ...
        return (
          <svg viewBox="0 0 34 34" height="32px" width="32px" className="github">
            <path
              ...
              clipRule="evenodd"
              fill="#FFFFFF"
              d="M32.6,16.3c0,7.2-4.7,13.3-11.1,15.5c-0.8,0.2-1.1-0.3-1.1-0.8
      ...
      case 'discord':
        return (
          <svg viewBox="0 0 245 240" height="32px" width="32px" className="discord">
            <path
              fill="#123456"
              d="M104.4,103.9c-5.7,0-10.2,5-10.2,11.1s4.6,11.1,10.2,11.1c5.7,0,10.2-5,10.2-11.1
            ...
            <path
              fill="#000000"
              d="M189.5,20h-134C44.2,20,35,29.2,35,40.6v135.2c0,11.4,9.2,20.6,20.5,20.6h113.4l-5.3-18.5l12.8,11.9l12.1,11.2
